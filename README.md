...
Remember to always run main.R first, even if you run the other scripts manually and not trough main script. This is needed because most libraries are currently downloaded in main.R. 
...
4. Run main script to define, fit and validate models, or run those scripts manually. Exploratory analysis might be better to to run manually
